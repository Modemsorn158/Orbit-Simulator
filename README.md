...
| **Simulation** | • Simulate spacecraft state vectors `(x, y, vx, vy)` based on input parameters<br>• Optional collision checking |
...
## Physics model
- Two-dimensional
- Earth fixed at origin `(0, 0)`
- Single point spacecraft
- Newtonian gravity
- SI units
- No atmospheric calculations
- No multi-body calculations\
Example gravitational acceleration equation; Input parameters `x, y`:\
